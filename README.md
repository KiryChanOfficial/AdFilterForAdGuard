...
- 2025.10  
    > 1. 主规则更新中。  
    > 2. 新增Quantumult X懒人规则（测试），黑名单由主规则转换  

- 2025.08  
    > 1. 更新`七猫小说`的拦截规则。由用户 [qq5460168](https://github.com/KiryChanOfficial/AdFilterForAdGuard/issues/5) 提供。  
    > 2. 新增两项VIVO浏览器拦截内容。  
...
- 2025.07  
    ...
    > 2. 更新了部分规则。  
    > 3. 持续更新中，由于`七猫小说`的更新目前已无法做到完全无广。  
    > 4. 更新`七猫小说`和`哔哩哔哩`部分广告规则。  

- 2025.06  
    > 1. 更新部分`腾讯`、`七猫小说`、`厂商广告`等拦截项  

- 2025.05  
    > 1. 新增`AM广告`、`趣盟广告`、`拼多多某拦截项`和`VIVO广告服务`。
...
- 2025.03  
    ...
    > 3. 新增拦截项`佳投广告（测试）`  
    > 4. 优化`腾讯广告服务`（也可能优化了个寂寞）  

- 2025.02  
    > 1. 新增拦截项`百度联盟`、`哔哩哔哩开屏广告（测试）`  

- 2024.12  
    > 1. 新增VIVO广告拦截（由VIVO提供的广告服务，并非VIVO系统中的广告）  
    > 2. 解决了部分情况下`淘宝系APP`无法登录的情况。  
